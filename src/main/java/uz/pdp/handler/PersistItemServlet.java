...
@WebServlet("/cabinet/browse/persist")
public class PersistItemServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        if (amount <= productDAO.getQuantity(productId)) {
            lineItemDAO.persistLineItem(productId, basketId, amount);
        } else {
